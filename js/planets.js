...
(function () {
  ...
  SM.PLANETS = [
    {
      ...
      orbit: 0, angle: 156, size: 74, defaultAreas: ['health', 'mental'],
      sections: [
    ...
    {
      id: 'learning', name: 'التعلم الذاتي', en: 'LEARNING', color: '#38bdf8',
      orbit: 1, angle: 244, size: 84, defaultAreas: ['learning', 'skills'],
      sections: [
        { id: 'dash',      name: 'اللوحة العامة',       icon: '🛰️' },
    ...
    },
    {
      ...
      orbit: 1, angle: 42, size: 92, defaultAreas: ['money'],
      sections: [
        { id: 'dash',     name: 'اللوحة العامة',  icon: '🛰️' },
    ...
    {
      id: 'hobbies', name: 'الهوايات', en: 'HOBBIES', color: '#e879f9', rainbow: true, ring: true,
      orbit: 2, angle: 200, size: 84, defaultAreas: ['skills'],
      sections: [
        { id: 'dash',     name: 'اللوحة العامة',    icon: '🛰️' },
    ...
    },
    {
      ...
      orbit: 2, angle: 335, size: 70, defaultAreas: ['study'],
      sections: [
        { id: 'dash',     name: 'اللوحة العامة',        icon: '🛰️' },
  ...
  SM.planetById = function (id) {
    ...
    return {
      ...
      orbit: 2, size: 62, sections: SM.CUSTOM_SECTIONS, defaultAreas: SM.AREAS.map(a => a.id),
    };
  };
